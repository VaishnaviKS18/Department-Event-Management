 ...
 * @author Swast
 */
public class compitetions extends javax.swing.JFrame {

    /**
     * Creates new form compitetions
     */
    public compitetions() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel8.setText(" PARTICIPANTS INFORMATIONS");
        ...
        jLabel9.setText(" PARTICIPANTS INFORMATIONS");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(compitetions.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new compitetions().setVisible(true);
            }
        });
    }
